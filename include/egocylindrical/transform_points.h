...
namespace egocylindrical
{
    ...
    namespace utils
    {
      ...
      inline
      void transform_impl(const S& points, P& transformed_points, const float*  const _R, const float*  const _T)
        {
        ...
        template <typename S, typename P>
        inline
        void transformPoints(const S& points, P& transformed_points, const geometry_msgs::TransformStamped& trans)
        {
