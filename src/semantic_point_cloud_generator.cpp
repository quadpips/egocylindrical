...
namespace egocylindrical
{
    ...
    void SemanticPointCloudGenerator::ecPointsCB(const egocylindrical_msgs::msg::EgoCylinderPoints::ConstPtr& ec_msg)
    {
        ...
        if(pc_pub_.getNumSubscribers()>0)
        {
          ...
          sensor_msgs::msg::PointCloud2::ConstPtr msg = utils::generate_semantic_point_cloud(ec_pts);
