...
namespace egocylindrical
{
    ...
    /**
    * @brief Nodelet-wrapper of the EgocylindricalFloorImageNodelet class
    */
    class EgocylindricalFloorImageNodelet : public nodelet::Nodelet
    {
    public:
      EgocylindricalFloorImageNodelet(){};
      ~EgocylindricalFloorImageNodelet(){}
      ...
      */
      virtual void onInit()
      {
        ...
        propagator_ = std::make_shared<EgoCylinderFloorImageGenerator>(nh, pnh);
    ...
    private:
      std::shared_ptr<EgoCylinderFloorImageGenerator> propagator_;
    };
    

PLUGINLIB_EXPORT_CLASS(egocylindrical::EgocylindricalFloorImageNodelet,
                       nodelet::Nodelet);
// %EndTag(FULLTEXT)%
